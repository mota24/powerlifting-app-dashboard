...
-- ============================================================
-- CLASSEMENT AU MOIS, SÉRIE STRICTE — à coller dans Supabase > SQL Editor.
--
-- Remplace migration_classement_mois.sql (même fonction, règle de série
-- corrigée) : inutile de relancer l'ancien fichier.
--
-- Le classement se joue sur le mois et repart de zéro au mois suivant ;
-- l'app garde la liste des mois passés avec leur vainqueur.
--
...
--   2. La série exige une validation CHAQUE jour : un jour sans « séance
--      terminée » ni « jour de repos » validé la remet à zéro, même si rien
--      n'était prévu ce jour-là.
...
-- classement_semaines reste en place : l'app s'en sert pour le récapitulatif
-- du dimanche, et elle applique déjà la même définition du jour actif.
-- ============================================================
