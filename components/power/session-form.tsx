...
import { MOIS_HISTORIQUE_RECORDS, POINTS_RECORD, recordsBattus, type LigneHistorique } from '@/lib/records'
import { appliquerPoints, pointsGagnes } from '@/lib/xp'
import { REST_NAMES, activiteReposVide, creerExerciceVierge, ecrireActiviteRepos, estCardio, exerciceVide, lireActiviteRepos, serieSuivante, formatDateAffichage, videSet, type ActiviteRepos, type ExerciceRow, type UserProgress, type WorkoutSetRow } from '@/lib/seance'
import { BlocReposActif } from '@/components/power/repos-activite'
    ...
    <div className="space-y-6 animate-in fade-in pb-10">
      ...
      {isRestDayMode ? (
        <div className="space-y-6 animate-in fade-in">
          ...
          <BlocReposActif activite={activiteRepos} t={t} onChange={setActiviteRepos} />
