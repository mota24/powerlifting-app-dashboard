...
import { REST_NAMES, creerExerciceVierge, estCardio, exerciceVide, serieSuivante, formatDateAffichage, videSet, type ExerciceRow, type UserProgress, type WorkoutSetRow } from '@/lib/seance'
