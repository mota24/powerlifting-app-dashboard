      ...
      <div className="mx-auto max-w-2xl space-y-12">
        ...
        <section className="space-y-4">
          ...
          <ul className="list-inside text-xs font-bold uppercase tracking-wider text-zinc-500 space-y-3 leading-relaxed">
            ...
            <li>— <strong className="text-white">DONNÉES DE SANTÉ :</strong> DOULEUR, SOMMEIL, FATIGUE, PAS (ART. 9 RGPD).</li>
          </ul>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p className="text-xs font-bold uppercase tracking-wider text-zinc-500 leading-relaxed">
            LES DONNÉES SONT CONSERVÉES TANT QUE LE COMPTE EST ACTIF. LES PAS QUOTIDIENS SONT SUPPRIMÉS À LA SUPPRESSION DU COMPTE.
          </p>
        </section>
